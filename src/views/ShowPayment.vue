                                ...
                                <div class="grid">
                                    ...
                                    <div class="col-12 md:col-6">
                                        <div class="field">
                                            ...
                                            <p class="mt-2 mb-0 text-700">{{ payment.costumer.phone || '-' }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="grid">
                                    ...
                                    <div class="col-12 md:col-6">
                                        <div class="field">
                                            ...
                                            <p class="mt-2 mb-0 text-700">{{ formatCurrency(payment.invoice.total_amount) }}</p>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="field">
                            ...
                            <div class="grid">
                                <div class="col-12 md:col-4">
                                    <div class="field">
                                        ...
                                        <p class="mt-2 mb-0 text-700">{{ formatDateTime(payment.created_at) }}</p>
                                    </div>
                                </div>
                                <div class="col-12 md:col-4">
                                    <div class="field">
                                        <label class="font-medium text-900">Última atualização</label>
                                        <p class="mt-2 mb-0 text-700">{{ formatDateTime(payment.updated_at) }}</p>
                                    </div>
                                </div>
                                <div class="col-12 md:col-4">
                                    <div class="field">
