...
const getData = async (page = 1) => {
    axios
        .get(`${baseURL}/supplier-category?page=${page}`, {
            params: {
...
<template>
    ...
    <div class="grid" v-else>
        <div class="col-12">
            <div class="card">
                <div class="flex border-bottom-1 border-gray-300 mb-3">
                    <router-link
                        to="/suppliers"
                        class="px-3 py-2 border-b-2"
                        :class="{
                            'border-primary text-primary font-bold': $route.path === '/suppliers',
                            'border-transparent text-gray-600 hover:text-primary': $route.path !== '/suppliers'
                        }"
                    >
                        Fornecedores
                    </router-link>
                    ...
                    <router-link
                        ...
                        class="px-3 py-2 ml-4 border-b-2"
                        :class="{
                            'border-primary text-primary font-bold': $route.path.startsWith('/suppliers/category'),
                            'border-transparent text-gray-600 hover:text-primary': !$route.path.startsWith('/suppliers/category')
                        }"
                    >
                        Categorias
                    </router-link>
                ...
                >
                    <template #header>
                        <div class="flex justify-content-between flex-column sm:flex-row">
                            <router-link to="/suppliers/category/create">
                    ...
                    <Column header="Ações" style="min-width: 12rem">
                        <template #body="{ data }">
                            <router-link class="m-3" :to="'/suppliers/category/' + data.id + '/edit'"><i class="pi pi-file-edit"></i></router-link> <router-link class="m-3" :to="'/suppliers/category/' + data.id"><i class="pi pi-eye"></i></router-link>
