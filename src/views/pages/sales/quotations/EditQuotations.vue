    ...
    try {
        ...
        if (response.status?.toUpperCase() !== 'DRAFT') {
            toast.add({
                severity: 'warn',
                summary: 'Atenção',
                detail: 'Esta cotação não pode ser editada pois não está em estado de rascunho',
                life: 5000
            });
        ...
        formData.value = {
            ...
            quotation_date: new Date(response.quotation_date),
...
const saveQuotation = async () => {
    ...
    try {
        ...
        const quotationData = {
            ...
            quotation_date: formData.value.quotation_date.toISOString().split('T')[0],
            expiry_date: formData.value.expiry_date.toISOString().split('T')[0],
        ...
        toast.add({
            severity: 'success',
            summary: 'Sucesso',
            detail: 'Cotação atualizada com sucesso',
            life: 3000
        });
