...
const onSubmit = handleSubmit((values) => {
    ...
    axios
        .patch(`${baseURL}/stock-movement/${router.currentRoute.value.params.id}`, values)
        .then((response) => {
            // resetForm();
            router.back();
...
const getData = async (page = 1) => {
    axios
        .get(`${baseURL}/stock-movement/${router.currentRoute.value.params.id}`, {
            params: {
        ...
        .then((response) => {
            ...
            // category.value = retriviedData.value.category;
            _method.value = 'put';
...
const deleteData = () => {
    ...
    axios
        .delete(`/api/stock-movement/${dataIdBeingDeleted.value}`)
        .then(() => {
            ...
            <div class="card p-fluid">
                ...
                <form @submit.prevent="onSubmit">
                    <div class="field">
                        ...
                        <InputText v-model="name" id="name" placeholder="Nome do turno" :class="{ 'p-invalid': errors.name }" type="text" />
                    ...
                    <!-- <div class="field">
                        ...
                        <InputText v-model="category" id="category" placeholder="Categoria" :class="{ 'p-invalid': errors.category }" type="text" />
