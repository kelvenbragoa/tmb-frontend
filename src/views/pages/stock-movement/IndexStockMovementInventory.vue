...
const schema = yup.object({
    ...
    unique_code: yup.string().required().trim().label('Category')
});
...
setFieldValue('stock_movement_type_id', 4);
...
const getData = async (page = 1) => {
    axios
        .get(`${baseURL}/stock-movement?page=${page}&stockMovementTypeId=4`, {
            params: {
...
<template>
    ...
    <Dialog header="Saída de Stock" v-model:visible="displayCreateStock" :style="{ width: '640px' }" :modal="true">
