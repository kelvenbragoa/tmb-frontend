...
const getData = async (page = 1) => {
    axios
        .get(`${baseURL}/stock-movement?page=${page}`, {
            params: {
                ...
                >
                    <template #header>
                        <div class="flex justify-content-between flex-column sm:flex-row">
                            <router-link to="/stock-movement/create">
                    ...
                    <Column header="Ações" style="min-width: 12rem">
                        <template #body="{ data }">
                            <router-link class="m-3" :to="'/stock-movement/' + data.id + '/edit'"><i class="pi pi-file-edit"></i></router-link> <router-link class="m-3" :to="'/stock-movement/' + data.id"><i class="pi pi-eye"></i></router-link>
