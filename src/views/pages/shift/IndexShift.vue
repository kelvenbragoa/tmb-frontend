...
const deleteData = () => {
    ...
    axios
        .delete(`${baseURL}/shift/${dataIdBeingDeleted.value}`)
        .then(() => {
            ...
            <div class="card">
                ...
                >
                    ...
                    <Column header="Ações" style="min-width: 12rem">
                        <template #body="{ data }">
                            <router-link class="m-3" :to="'/shift/' + data.id + '/edit'"><i class="pi pi-file-edit"></i></router-link> <router-link class="m-3" :to="'/shift/' + data.id"><i class="pi pi-eye"></i></router-link>
