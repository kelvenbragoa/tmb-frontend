...
const onSubmit = handleSubmit((values) => {
    ...
    axios
        .patch(`${baseURL}/shift/${router.currentRoute.value.params.id}`, values)
        .then((response) => {
            // resetForm();
            router.back();
...
const getData = async (page = 1) => {
    axios
        .get(`${baseURL}/shift/${router.currentRoute.value.params.id}`, {
            params: {
...
const deleteData = () => {
    ...
    axios
        .delete(`/api/shift/${dataIdBeingDeleted.value}`)
        .then(() => {
