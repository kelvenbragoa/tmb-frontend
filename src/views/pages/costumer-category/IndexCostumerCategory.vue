...
const deleteData = () => {
    ...
    axios
        .delete(`${baseURL}/costumer-category/${dataIdBeingDeleted.value}`)
        .then(() => {
                ...
                >
                    <template #header>
                        <div class="flex justify-content-between flex-column sm:flex-row">
                            <router-link to="/costumer-category/create">
                    ...
                    <Column header="Ações" style="min-width: 12rem">
                        <template #body="{ data }">
                            <router-link class="m-3" :to="'/costumer-category/' + data.id + '/edit'"><i class="pi pi-file-edit"></i></router-link> <router-link class="m-3" :to="'/costumer-category/' + data.id"><i class="pi pi-eye"></i></router-link>
