...
const onSubmit = handleSubmit((values) => {
    ...
    axios
        .post(`${baseURL}/point-of-sale`, values)
        .then((response) => {
            // resetForm();
            router.back();
...
const getData = async (page = 1) => {
    axios
        .get(`${baseURL}/api/point-of-sale/create`, {
            params: {
...
const deleteData = () => {
    ...
    axios
        .delete(`/api/point-of-sale/${dataIdBeingDeleted.value}`)
        .then(() => {
            ...
            <div class="card p-fluid">
                ...
                <form @submit.prevent="onSubmit">
                    <div class="field">
                        ...
                        <InputText v-model="name" id="name" placeholder="Nome da Ponto de Venda" :class="{ 'p-invalid': errors.name }" type="text" />
