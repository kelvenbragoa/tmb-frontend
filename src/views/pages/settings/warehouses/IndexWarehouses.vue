...
const getData = async (page = 1) => {
    axios
        .get(`${baseURL}/stockcenters?page=${page}`, {
            params: {
...
const deleteData = () => {
    ...
    axios
        .delete(`${baseURL}/stockcenters/${dataIdBeingDeleted.value}`)
        .then(() => {
        ...
        <div class="col-12">
            <div class="card">
                ...
                >
                    ...
                    <Column header="Principal" style="min-width: 12rem">
                        <template #body="{ data }">
                            {{ data.is_main_stock_center ? 'Sim' : 'Não' }}
                        </template>
                    </Column>
                    ...
                    <Column header="Ações" style="min-width: 12rem">
                        <template #body="{ data }">
                            <router-link class="m-3" :to="'/settings/warehouses/' + data.id + '/edit'"><i class="pi pi-file-edit"></i></router-link>
                            <router-link class="m-3" :to="'/settings/warehouses/' + data.id"><i class="pi pi-eye"></i></router-link>
