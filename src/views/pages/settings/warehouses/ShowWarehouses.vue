    ...
    <div class="flex flex-col md:flex-row gap-12" v-else>
        <div class="w-full">
            <div class="card">
                ...
                <p><strong>Ponto de Venda:</strong> {{ retriviedData.name }}</p>
                <p><strong>Descrição:</strong> {{ retriviedData.description }}</p>
                <p><strong>Localização:</strong> {{ retriviedData.location }}</p>
                <!-- <p><strong>Categoria:</strong> {{ retriviedData.category }}</p> -->
