    ...
    setup() {
        ...
        const loadCustomerInvoices = async (customerId) => {
            ...
            try {
                ...
                customerInvoices.value = response.items || [];
            } catch (error) {
        ...
        const savePayment = async () => {
            ...
            try {
                ...
                if (paymentData.payment_date) {
                    paymentData.payment_date = formatDateForAPI(paymentData.payment_date);
                }
                if (paymentData.due_date) {
                    paymentData.due_date = formatDateForAPI(paymentData.due_date);
                }
            ...
            <div class="card">
                <div class="flex align-items-center justify-content-between mb-4">
                    <h5 class="m-0">
                        ...
                        <span v-if="paymentType" class="ml-2 text-sm"> ({{ getPaymentTypeLabel(paymentType) }}) </span>
                    </h5>
                ...
                <form @submit.prevent="savePayment">
                    <div class="grid">
                        ...
                        <div class="col-12 md:col-4">
                            <div class="field">
                                ...
                                <InputText id="payment_number" v-model="payment.payment_number" placeholder="Será gerado automaticamente se vazio" class="w-full" />
                            </div>
                        </div>
                        ...
                        <div class="col-12 md:col-4">
                            <div class="field">
                                ...
                                <Calendar id="payment_date" v-model="payment.payment_date" dateFormat="dd/mm/yy" :showIcon="true" placeholder="Selecione a data" :class="{ 'p-invalid': errors.payment_date }" class="w-full" />
                        ...
                        <div class="col-12 md:col-4">
                            <div class="field">
                                ...
                                <Dropdown id="status" v-model="payment.status" :options="paymentStatuses" optionLabel="label" optionValue="value" placeholder="Selecione o status" :class="{ 'p-invalid': errors.status }" class="w-full" />
                        ...
                        <div class="col-12 md:col-6">
                            <div class="field">
                                ...
                                <InputText id="reference" v-model="payment.reference" placeholder="Ex: Número do cheque, referência bancária, etc." class="w-full" />
                            </div>
                        </div>
                        ...
                        <div class="col-12 md:col-6">
                            <div class="field">
                                ...
                                <Calendar id="due_date" v-model="payment.due_date" dateFormat="dd/mm/yy" :showIcon="true" placeholder="Selecione a data (opcional)" class="w-full" />
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="field">
                                ...
                                <Textarea id="description" v-model="payment.description" rows="3" placeholder="Observações sobre o pagamento..." class="w-full" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-content-end gap-2 mt-4">
                        ...
                        <Button :label="isEditing ? 'Atualizar' : 'Criar'" :icon="isEditing ? 'pi pi-check' : 'pi pi-plus'" type="submit" :loading="saving" class="p-button-primary" />
                    </div>
                </form>
            </div>
        </div>
