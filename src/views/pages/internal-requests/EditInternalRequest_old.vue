...
// Simular usuário logado (em produção virá do auth store)
const currentUser = {
    id: 1,
    name: 'João Silva',
...
const form = reactive({
    ...
    description: '',
    priority: 'medium',
    requestedBy: currentUser.name, // Preenchido automaticamente
    requestDate: null,
    requiredDate: null,
    items: [],
    notes: ''
...
const loadRequest = async () => {
    try {
        ...
        Object.assign(form, {
            ...
            requestedBy: currentUser.name, // Mantém o usuário logado
...
const canEdit = computed(() => {
    ...
    return InternalRequestService.canEdit(originalRequest.value, currentUser);
});
            ...
            <div class="card">
                ...
                <form v-else-if="originalRequest" @submit.prevent="save">
                    ...
                    <Message 
                        ...
                        class="mb-4"
                    >
                        Esta requisição não pode ser editada no status atual.
                    </Message>
                            ...
                            <div class="col-12 md:col-6">
                                <div class="field">
                                    ...
                                    <Calendar 
                                        ...
                                        placeholder="Selecione a data da requisição"
                                        class="w-full"
                                        :class="{ 'p-invalid': errors.requestDate }"
                                        dateFormat="dd/mm/yy"
                                        :showIcon="true"
                                        :disabled="!canEdit"
                                    />
